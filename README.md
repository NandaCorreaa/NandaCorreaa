...
[![Typing SVG](https://readme-typing-svg.herokuapp.com/?font=Parkinsans&weight=500&pause=500&color=ff52c8&size=30&center=true&vCenter=true&width=1000&lines=Olá,+Meu+nome+é+Fernanda+Corrêa+❤️;+Sou+Formada+Em+Desenvolvimento+Web+Front-End+👩‍💻;+Atuo+como+Instrutora+de+Desenvolvimento+Web+FullStack👩‍💻;Sejam+Bem+Vindos!+😊)](https://git.io/typing-svg)
...
Atualmente, atuo como Instrutora de Desenvolvimento Web FullStack!

Minha habilidade em comunicação sempre foi uma das minhas maiores forças, e tenho um grande prazer em compartilhar o que sei, além de aprender com os outros a cada dia. Estou empolgada para seguir expandindo meus horizontes e enfrentar novos desafios nessa jornada de desenvolvimento. 👩🏻‍💻
...
<div>
  ...
  <a target="_blank" href="https://www.linkedin.com/in/fernandacorrêa" style="text-decoration: none;">
   ...
   <a target="_blank" href="https://www.instagram.com/__nandacorrea/" style="text-decoration: none;">
...
<div>
  ...
  <img alt="Canva" src="https://img.shields.io/badge/Canva-646CFF?style=for-the-badge&logo=canva&logoColor=white" />
</div>


## ❣️ Meus projetos favoritos:

- [**Clone da página da TeleCine - Desenvolvido em ReactJS e Styled-Components**](https://tele-cine-project-by-fernanda-correa.vercel.app/)
- [**Site do Harry Potter - Desenvolvido em ReactJS e Styled-Components**](https://harry-potter-by-fernanda-correa.vercel.app/)
- [**Calculadora - Desenvolvido em ReactJS e Styled-Components**](https://calculator-fernanda-correa.vercel.app/)
- [**Site dos Vingadores - Desenvolvido em ReactJS e Styled-Components**](https://avengers-by-fernanda-correa.vercel.app/)
- [**Super Mário - MiniGame - Desenvolvido em HTML, CSS e JavaScript**](https://nandacorreaa.github.io/SuperMario-MiniGame/)
